...
\begin{frame}{The HTTP \textbf{Request} message structure}
    \centering
    \includegraphics[width=\linewidth]{figures/http-req.png}
\end{frame}

\begin{frame}{The HTTP \textbf{Response} message structure}
    \centering
    \includegraphics[width=\linewidth]{figures/http-res.png}
\end{frame}
...
\begin{frame}{HTTP Methods as CRUD operations}
    \begin{center}
        \includegraphics[width=\linewidth]{figures/http-methods.png}
    \end{center}
...
\begin{frame}{\textbf{Full} structure of URL}
    \begin{center}
        \includegraphics[height=.8\textheight]{figures/http-url.png}
    \end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{MIME types}
    ...
    \begin{center}
        \includegraphics[width=\linewidth]{figures/mime_types.png}
        \small
...
\begin{frame}{Example -- OpenAPI schema for \texttt{User} data type}
    ...
    \begin{columns}[t]
        \begin{column}{.49\textwidth}
            \lstinputlisting[language=yaml]{listings/User.yaml}
        \end{column}
        \hfill
        \begin{column}{.49\textwidth}
            \lstinputlisting[language=yaml]{listings/UserInstance.yaml}
            \lstinputlisting[language=yaml]{listings/UserInstance.json}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[allowframebreaks]{Main structure of a OAS specification file}
    \lstinputlisting[language=yaml]{listings/SwaggerMain.yaml}
\end{frame}

\begin{frame}[allowframebreaks]{Route definition example}
    \lstinputlisting[language=yaml]{listings/RouteExample.yaml}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    Creating a client:
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/HttpClient.java}

    \framebreak

    Creating a request:
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/HttpRequest.java}
    ...
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/HttpRequestWithQuery.java}

    \framebreak

    Handling a response:
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/HttpResponse.java}
...
\begin{frame}[allowframebreaks]
    ...
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/Javalin101.java}

    \framebreak

    Setting up routes in Javalin via lambda expressions:
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/JavalinRoutes.java}
    ...
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/JavalinRoutesNoLambda.java}
...
\begin{frame}[allowframebreaks]\frametitle{Javaling Usage Example}

    \lstinputlisting[language=Java,morekeywords={var},basicstyle=\ttfamily\tiny]{./listings/JavalinRouteStub.java}
    %
    \begin{itemize}
    ...
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/JavalinFilter.java}
    %
    Use cases:
    %
    \begin{itemize}
...
%            \item[\texttt{Presentation}] class --- entry point for getting a (de)serialiser instance for some actual type
    ...
    %
    \lstinputlisting[language=Java,morekeywords={var},basicstyle=\ttfamily\tiny]{./listings/CustomerApi.java}

    \framebreak

    Example of customer Controller:
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/CustomerController.java}

    \framebreak

    Example of customer Storage (in-memory database):
    %
    \lstinputlisting[language=Java,morekeywords={var},basicstyle=\ttfamily\tiny]{./listings/CustomerStorage.java}
