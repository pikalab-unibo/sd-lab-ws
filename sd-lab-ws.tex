...
\begin{frame}[allowframebreaks]
    ...
    Example stub:
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/JavalinRouteStub.java}
    %
    \begin{itemize}
...
%            \item[\texttt{Presentation}] class --- entry point for getting a (de)serialiser instance for some actual type
    ...
    %
    \lstinputlisting[language=Java,morekeywords={var}]{./listings/CustomerStorage.java}
