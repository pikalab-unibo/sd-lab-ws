...
\begin{frame}{Client- vs. Server-side}
    ...
    \begin{itemize}
        \item When working HTTP, developers rarely implement the protocol from scratch
...
\begin{frame}{Implementation -- Client-Side vs. Server-Side}
    ...
    \begin{block}{The \textbf{client}-side: \texttt{sd.lab.linda.textual.impl.\alert{RemoteTupleSpace}}}
        \begin{itemize}
